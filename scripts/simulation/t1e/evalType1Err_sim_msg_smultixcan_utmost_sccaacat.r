# script to evaluate t1e



# test run
# Rscript evalType1Err_sim_msg_smultixcan_utmost_sccaacat.r  --m 200 --p 300 --n 50000 --Ti 10  --Nsim 2  --hc 0.05 --hz 0.01 --s 0.05 --shares 0.3 --shareTi 2 --rhoX 0.1 --rhoE 0.5 --batch 1

# run more jobs (e.g. 20000 here)
# parallel --dryrun Rscript  evalType1Err_sim_msg_smultixcan_utmost_sccaacat.r --m 200 --p 300 --n 50000 --Ti 10 --Nsim 200  --hc {1} --hz 0 --s {2} --shares 0.3 --shareTi {3} --rhoX 0.1 --rhoE 0.5 --batch {4} ::: 0.01 0.05 0.1 ::: 0.01 0.05 0.1  ::: 2  4  8  ::: $(seq 1 1 100) > tmpjob

# submit to cluster
# less tmpjob | perl ssub_array2 -pd `pwd`  -pm 40000 -ph 15 -email xx  -e
...
option_list <- list(
    ...
    make_option(c("--s"), action="store", # sparsity in paper, fraction of nonzero
                default=0.1,
...
# genotypes in eQTL
                ...
                # cca: function from file cca_092930.R, individual level

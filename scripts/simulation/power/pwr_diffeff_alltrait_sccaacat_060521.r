...
# simulation set 2
# 1)  all tissues sharing snps contribute to trait, but the effect size is random,

# 
# test run
# Rscript pwr_diffeff_alltrait_sccaacat_060521.r  --m 200 --p 300 --n 50000 --Ti 10  --Nsim 2  --hc 0.05 --hz 0.01 --s 0.05 --shares 0.3 --shareTi 2 --rhoX 0.1 --rhoE 0.5 --batch 1

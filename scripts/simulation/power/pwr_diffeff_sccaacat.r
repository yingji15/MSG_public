...
# test run
# Rscript /home/jiy1/CCA_scripts/TisCoMM/simulation/evalType1Err_args_diffeff_scca_twas_052621.r  --m 200 --p 300 --n 50000 --Ti 10  --Nsim 2  --hc 0.05 --hz 0.01 --s 0.05 --shares 0.3 --shareTi 2 --rhoX 0.1 --rhoE 0.5 --batch 1
